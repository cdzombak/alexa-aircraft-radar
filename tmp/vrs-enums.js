...
(function(VRS) {
    ...
    VRS.globalOptions.aircraftPictureSizeDesktopDetail = VRS.globalOptions.aircraftPictureSizeDesktopDetail || {
        width: 350
    };
    VRS.globalOptions.aircraftPictureSizeInfoWindow = VRS.globalOptions.aircraftPictureSizeInfoWindow || {
        width: 85,
        height: 40
    };
    VRS.globalOptions.aircraftPictureSizeIPadDetail = VRS.globalOptions.aircraftPictureSizeIPadDetail || {
        width: 680
    };
    VRS.globalOptions.aircraftPictureSizeIPhoneDetail = VRS.globalOptions.aircraftPictureSizeIPhoneDetail || {
        width: 260
    };
    VRS.globalOptions.aircraftPictureSizeList = VRS.globalOptions.aircraftPictureSizeList || {
        width: 60,
        height: 40
    };
    ...
    VRS.LinkSite = {
        ...
        FlightAwareDotCom: 'flightaware',
        GoogleImageSearch: 'googleimages',
        PlaneLogger: 'PlaneLogger',
        StandingDataMaintenance: 'sdm',
        ADSBXdbEditor: 'ADSBXdbEditor',
        ADSBXflightdata: 'ADSBXflightdata'
    };
    VRS.MapControlStyle = {
        Default: 'a',
        DropdownMenu: 'b',
...
})(VRS || (VRS = {})); //# sourceMappingURL=enums.js.map
